...
```
.\installer.py  (install libraries/binaries)
...
.\scripts\interface.py  (program interface for SecondLlama)
.\scripts\detection.py  (detection of text/images in SecondLife) 
.\scripts\controller.py  (controls actions made by AI in SecondLife)
